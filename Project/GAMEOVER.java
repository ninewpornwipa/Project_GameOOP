...
public class GAMEOVER extends JPanel {
    private ImageIcon background = new ImageIcon(this.getClass().getResource("endback.jpg"));
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(exit.getImage(),850,500, 60,60 ,this);
        g.setFont(new Font("2005_iannnnnTKO",Font.CENTER_BASELINE,70));
        g.setColor(Color.red);
        g.drawString("NEW MISSION",300,100);
